...
import {
  ...
  UserX, Package, Users, Wrench, Coffee, ClipboardList,
} from 'lucide-react';
...
const TOOL_META = {
  ...
  'production-checklists': { Icon: ClipboardList,   description: 'Checklists for brewery production operations',            page: 'production-checklists' },
