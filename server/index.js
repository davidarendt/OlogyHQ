...
if (!fs.existsSync(productionUploadDir)) fs.mkdirSync(productionUploadDir, { recursive: true });
...
if (!fs.existsSync(sopUploadDir)) fs.mkdirSync(sopUploadDir, { recursive: true });
